...
class Keberangkatan2 extends CI_Controller {
	
	public function  __construct() {
		parent::__construct();
		$this->load->model('MKeberangkatan2', 'modal');
	...
	public function index() {
		...
		$template = array(
			...
			'konten' => $this->load->view('keberangkatan/viewdata2', '', true),
